    ...
    <div class="content-wrapper">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date">
                                                ...
                                                <input id="teacherName" name="teacherName" type="text" class="form-control pull-right" placeholder="请输入老师名字">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="teacherAge" class="col-sm-2 control-label">年龄</label>
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                <div class="input-group date">
                                                    ...
                                                    <input id="teacherAge" name="teacherAge" type="text" class="form-control pull-right" placeholder="请输入年龄">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="teacherFaculty" class="col-sm-2 control-label">院系</label>
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                <div class="input-group date">
                                                    <div class="input-group-addon">
                                                    ...
                                                    <select id="teacherFaculty" name="teacherFaculty" class="form-control pull-right">
                                    ...
                                    <div class="form-group">
                                        <label for="teacherCourse" class="col-sm-2 control-label">课程</label>
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                <div class="input-group date">
                                                    <div class="input-group-addon">
                                                    ...
                                                    <select id="teacherCourse" name="teacherCourse" class="form-control pull-right">
                                                        <option selected="selected">没有数据</option>
                                                    </select>
                                                </div>
                                            </div>
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">基础数据</a></li>
                <li class="active" ><a href="${pageContext.request.contextPath}/teacher/page">教师列表</a></li>
            </ol>
        </section>
        <!-- 内容头部 /-->
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">所教课程</th>
                                <th class="sorting_desc sorting_desc_disabled">入职时间</th>
                            ...
                            <tr>
                                ...
                                <td>java</td>
                                <td>2020-6-5</td>
                                <td class="text-center" style="background-color: #799c52;color: white">正常</td>
